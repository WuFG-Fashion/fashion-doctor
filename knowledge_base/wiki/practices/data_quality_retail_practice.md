...
sources: [L3_06_01_数据质量红线, 2026-06-08_2026企业数据质量五阶段管控, 2026-08-15_语义层与数据契约治理2026, 2026-08-15_主动元数据与多品牌数据目录2026]
created: 2026-06-08
updated: 2026-08-15
cross_refs: [[data_quality_governance]], [[零售数据仓库SQL实践]], [[SQL查询性能优化]], [[ETL架构选型]], [[2026-08-03_AI驱动数据质量管理_从规则到智能预防]], [[2026-08-03_服装零售指标口径统一与进销存SQL]], [[2026-08-09_Melissa信通院_零售数据质量2026可信度基准], [[2026-08-15_语义层与数据契约治理2026]], [[2026-08-15_主动元数据与多品牌数据目录2026]]]
---
