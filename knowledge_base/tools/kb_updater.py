...
L2_MAP = {
    ...
    "L2_03_商品企划":      {"id": "L2_03", "name": "商品企划",          "desc": "OTB管理、波段上货、商品生命周期"},
    "L2_04_会员运营":      {"id": "L2_04", "name": "会员运营",          "desc": "会员体系设计、RFM分层、VIP运营"},
    "L2_05_供应链与库存":  {"id": "L2_05", "name": "供应链与库存",      "desc": "期货管理、库存预警、死库处理"},
    "L2_06_行业动态":      {"id": "L2_06", "name": "行业动态与趋势",    "desc": "男装趋势、运动户外冲击"},
}
