...
待核实：① 库内并存「全球零售额约 $90 亿」（2025，TH 产品口径）与「FY2025 营收 47.71 亿美元」（PVH 财报批发口径）两个量级——前者为终端零售额、后者为品牌方营收，差异合理但**绝不可互用**，跨页比较须显式标口径；② 「2026 受关税约 215bp 拖累」为 PVH 指引口径，实际影响待季报验证。

跨页一致性：本页与本目录下 [[2026-09-11_A3_tommy_hilfiger_NYFW2027春季PlazaPrep大秀]] 同品牌不同维度（财务 vs 营销），两页的「$90 亿」引用须保持一致表述。
