...
**待核口径（本页为知识库已知高优先级矛盾项）**：门店数存在 **1,700+ / 1,800+ / 2,890** 三说并存——1,700+（2025 底）与 1,800+（2026-03）为品牌自宣且获第三方媒体 corroborate，2,890 溯源为搜狗百科 outlier（疑含加盟意向 / 口径较宽）已降权。**三说未正式裁定，引用时须写明口径与时点。**
