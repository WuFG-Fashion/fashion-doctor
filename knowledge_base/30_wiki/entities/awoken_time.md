...
> 本轮 A1 对本品做 2026 全维度核验，**第 10+ 轮零信号**（检索污染为主）。
- **唯一可核颗粒**：腾讯地图 POI 命中「**AWOKEN-TIME（武汉江宸天街店）**」——武汉市江汉区青年路 518 号武汉江宸天街 1F，营业 10:00-22:00、评分 4.0、人均 22 元——与 [[2026-08-23_A1_awoken_time_武汉多店清单与白猿宇宙]] 的武汉多店清单 **corroborate**（非新店、非新信号，仅确认点位仍在营）（置信度：第三方数据 / 地图 POI）。
- **建议（提请用户确认）**：同 [[awoken_space]]，**建议降级为季度探针**或移出 A 轮固定分组（连续 10+ 轮零信号、污染率近 100%）。在用户确认前维持每轮探针 + 显式记录。
- **结论（登记）**：品牌门店网络（武汉为主）稳定但**无扩张 / 财务 / 联名信号**；人均 22 元的 POI 口径偏低，疑似包含配饰或引流单品，**不宜作为客单价参考**。

## 前沿

**待核口径**：武汉「4+ 家」门店与单店「超 800㎡」面积均来自商业地产媒体（赢商网等）估算，非品牌官方口径；品牌仍处快速扩张期，门店清单变动快，**引用必须标注采集时点**。

**待核口径（二）**：上海泗泾招商花园城「2026 四季度开业」为签约状态，非已开业，需在 2026Q4 后回查落地结果。

**下轮采集焦点**：① 「白猿宇宙」IP（8.7 米装置 + 特调咖啡 + 周年庆 remake）的实际引流与转化数据——这是本页唯一可差异化的自有资产，但目前只有描述、没有量化；② 外拓城市（襄阳 / 宜昌 / 南昌）单店表现是否支撑「区域深耕再复制」的判断；③ 武汉门店数与 AWOKEN SPACE 口径的归属划分。
