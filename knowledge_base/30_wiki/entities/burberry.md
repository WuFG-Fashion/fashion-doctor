...
- **上游 · 来源支撑**：[[2026-06-28_贝尔财经_Burberry_FY2026年报]]（本页事实来自这些原始采集）
- **本页定位**：entity —— Burberry 博柏利
- 关联实体：[[lululemon]] · [[jnby]] · [[bienlefen]] · [[fast_retailing]]
- 关联概念：[[light_luxury_brand_framework_2026]] · [[ai_fashion_consumer_2026]] · [[agentic_commerce_fashion_2026]] · [[china_apparel_industry_2026q1]]
- 关联对比：无
- 关联打法：无
...
**下轮采集焦点**：① 中国区业绩的实际走势（本页未见中国区独立数据，需专项补采）；② 品牌重塑（近年的定位回调）在亚太市场的传导效果；③ 与知识库 `light_luxury_brand_framework_2026`（轻奢品牌三维框架）的定位是否仍匹配——若品牌定位已变动，该框架的适用边界需同步修订。
