...
created: 2026-08-14
updated: 2026-09-13
cross_refs: [[服装行业竞争格局]], [[peacebird]], [[cabbeen]], [[2026-08-17_diesel_2026联名与Pride营销]], [[2026-08-18_diesel_OTB2025业绩与新CEO任命]], [[listed_brand_metrics_template_2026]], [[2026-09-13_A1_diesel_OTB2025年报财务细化与大中华区113店]], [[brand_internationalization_2026]]
layer: T2
scope: brand
volatility: slow
as_of: 2026-09-13
...
## A1轮全维度采集织入（2026-09-13 · OTB 2025 年报财务细化）

> 本轮 A1 对本品做 2026 全维度核验，新增「OTB 2025 利润与门店口径」维度信号见 [[2026-09-13_A1_diesel_OTB2025年报财务细化与大中华区113店]]。
- **一句话摘要**：OTB 2025 营收约 €1.7B（-4.8%）、净销售 €1.6B（**-5.9% 实际汇率**）、**EBITDA €237.3M（-14%，利润率 15.1%）**、**营业利润 €44M→€10.1M（-77%）**、净财务状况 +29% 至 €40M、现金生成 €44M、无净负债；零售网络 **49 开 / 58 关**；日本占 **27.4%**、美国 +5.9%、中东 +9%、**欧洲与中国放缓（归因批发渠道）**；**大中华区 113 家直营店** + 明确继续扩张；**OTB 上海亚太总部 2025-10 揭幕**、Diesel 入华 20 年；Diesel 仍为集团**按销售计最大品牌**并录得十年最佳年；收购 Frassineti / Stephen、Dsquared² 续约五年、Amiri 日本分销、Brave Kid 内化 Diesel 鞋履线；IPO 无时间表；Saks Global 敞口有限（置信度：第三方数据，非上市集团无审计财报可核）。

**结论（织入）**：OTB 呈现**「营收小跌、利润崩塌、现金改善」**的反直觉组合——利润被主动投向直营店 / AI / 创意换血而非经营性失血，与 [[dkny]] 母公司 G-III「轻资产押自有品牌 + 延长授权」构成两种资本配置哲学对照。**对 Diesel 中国判断的关键修正是：放缓发生在批发渠道、直营网点（集团大中华区 113 家）仍在扩张**——叠加既有"联名中国区零落点"观察，可读为"资源从联名首发转向直营网络"，与 [[ellesse]] 美区"借 B2B 批发铺货、旗舰店后置"的相反路径形成渠道投入方向对照。**风险提示**：Diesel 品牌级无任何增速数字，不可进 [[listed_brand_metrics_template_2026]] 数值列；「大中华区 113 店」为集团口径且时点未明，不能与 571/573、2861 等同时点横比。
**信息链（织入）**：[[2026-08-30_diesel_OTB2025财报与新CEO与AI试穿]] → [[2026-09-13_A1_diesel_OTB2025年报财务细化与大中华区113店]] → 本页（[[diesel]]） → 下游 [[服装行业竞争格局]] / [[brand_risk_signals_2026]] / [[listed_brand_metrics_template_2026]] / [[dkny]]

## 前沿

**待核口径（2026-09-13 新增）**：Diesel CEO **Andrea Rigogliosi 任命时点**两说并存——库内 08-30 源记 **2026-01-14**；本轮检索百度百科记「**2025 年 1 月**同期」。两说来源均为低可核等级（百科 / 二手转述），**暂不判为数据矛盾**，待 OTB 官方稿或 FashionNetwork/WWD 原始报道确认。

**待核口径（二）**：「OTB 大中华区 113 家直营店」为**集团口径**（含 Margiela / Jil Sander / Marni），且时点未明——Diesel 单品牌占多少、是否 2025-12-31 口径均未知，**不可与同库其他品牌店数横比**。

**下轮采集焦点**：① **中国区直营店数与同店数据**（Diesel 全球处于品牌重塑期，需确认"批发放缓、直营扩张"假设是否成立）；② OTB 2026 半年报 / 全年预告（看 EBITDA 与营业利润是否修复）；③ 10-02 FFXIV 全球上线后是否有中国渠道落点；④ 与同属意大利 / 高端牛仔赛道的竞品对照；⑤ 知识库 `2026-09-02_B_diesel_商品结构与季末折扣管理` 页含品牌特有的商品结构数据，本页可反向引用该 B 轮佐证以补全商品维度。
