...
> **来源**：[[2026-08-15_ellesse_中国复古潮流与渠道速览_2026]]
> **最后更新**：2026-08-15
...
3. 女装占比 40%→60% 的目标，显示其向女装/潮流倾斜，与服装主业女装化趋势一致。
4. 数据风险：ellesse 单品牌财务不披露（Pentland 私营）；'鞋类翻倍'为合作目标非已实现，引用须标注。

## 信息链
- 上游来源：[[2026-08-15_ellesse_中国复古潮流与渠道速览_2026]] → 本页（[[ellesse]]）→ 下游应用：[[服装行业竞争格局]] · [[peacebird]] · [[cabbeen]]
...
> 本轮 A1 对本品做 2025-2026 全维度复核，最新核验数据见 [[2026-08-16_ellesse_2025-2026全维度复核]]；数值与 2026-08-15 入库一致（详见该源「ℹ️ 基准核对」），无新增硬信号、无矛盾。

### 信息链（A1轮）
- 上游来源：[[2026-08-16_ellesse_2025-2026全维度复核]] → 本页（[[ellesse]]）→ 下游合成：[[服装行业竞争格局]]、[[brand_portfolio_tiers_2026]]、[[brand_risk_signals_2026]]
...
- × Smiley 联名（2026-08-17）：70 年代 Rave 电音 + 笑脸，暖粉/暖阳黄高饱和，微笑登山帽 1,280 元。
- Andrew Garfield「Do It Like an Italian」FW2026 全球 campaign，强化意大利 heritage 叙事。
...
**待核口径（知识库已知标注不一致项）**：本页**页底标注为「媒体估算」，而 frontmatter `confidence` 字段标为「品牌自宣」**——两者不一致，需确定以哪一方为准（建议以来源实际等级判定，若数据来自品牌通稿则为品牌自宣，若来自第三方盘点则为媒体估算）。

**下轮采集焦点**：① `confidence` 标注不一致的收口；② 中国区门店与代理体系；③ 与同属运动休闲赛道的 Fila / Kappa 在华表现对照。
