...
> 本段为 A2 轮（本组 11 品牌·品牌主体全维度）对 [[marcelo_burlon]] 的 2025-2026 核验；本轮为每日增量验证轮。
...
**跨页裁定（遗留核实 · 2026-09-13）**：~~中国区运营主体存在 **New Guards Group vs Daddato Next** 两说~~——已核实为**时间线演变、非平行两说**（且属全球许可主体、不限于中国区）：2015-2019 NGG → 2019 起 Farfetch 体系 → 2025-07 全球许可移交 **Daddato Next**（首系列 2025 Fall，Burlon 保留 100% 所有权）；NGG 2024-11 破产保护为 Farfetch 体系内执行主体事件。**当前（2026）许可运营主体 = Daddato Next**，门店数与业绩数据归属以此为准。依据 WWD 等 4 家行业媒体一致（置信度：第三方数据），详见 [[2026-08-18_A2_marcelo_burlon_全维度动态]] 裁定行。

**下轮采集焦点**：① ~~运营主体裁定~~ ✅ 已裁定（2026-09-13）：Daddato Next，见前沿裁定行；② 全球首店 2017 香港已关后，中国借 D-mop 多品牌店铺货的现状（在售店铺清单）；③ Mapuche 十字符号系列的最新季度动向。
