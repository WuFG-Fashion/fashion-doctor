...
## 2026-09-13 07:20 执行摘要

**结果**：A3 固定分组 12 品牌**以品牌主体为中心·全维度综合采集**轮完成。**3 真新增 / 9 显式核验**（非静默跳过）。索引 **1414 L3**（+3）。矛盾 **0 新增** ✅（全库 ⚠️ 维持 09-06 基线未变）。断链 0（2361 条双链实测）、孤岛 0。实体编辑 12（3 实质 + 9 核验登记）+ 概念 2 回链 + 对比 2 回链。分段 2 次 commit + push main（95f5833 前半程 → 29ab0aa 后半程，HEAD==origin/main）。

**新增 3 源**（raw0→s3，全含结论+信息链+前沿+confidence+brand_specific:true）：
- **salomon**（第三方数据）：**XT-EVO 中国定价落地 ¥1,398**（京东官方旗舰店 合金灰 454191 / 黑色 454042）= 09-11 源「中国官网未公布统一标价」待验证项**部分闭环**；但**官方 9/1 官宣通篇无价格、全国统一标价仍缺**；**一周五价并行**（1,398/1,498/1,598/「5折」/「599两双」，全来自柜姐号/门店号/奥莱号/拼单号）→ **定价话语权外流**；柜姐文案自带「防水溢价约 ¥200」逻辑。
- **tommy_hilfiger**（品牌自宣）：**'Residence' 店型概念全球铺开**——都柏林 Dundrum 首发（2,088 sq ft 改造重开）→ **中国广州 9 月底** → 开普敦（**欧洲验证→中国复制** 顺序）；与 09-09 源 Shop-in-Shop 构成**重资产独立店型 × 轻资产店中店双线**；PVH 新任 CFO Alexis Rollier 9/14 高盛零售大会首秀。
- **peacebird**（官方公告）：**「太平转债」回售结果零申报闭环**——回售期 9/2-9/8、回售价 100.27 元/张、**有效申报 0 张 / 金额 0 元**（公告 2026-047）；触发背景 = 股价 7/15-8/25 连续 30 交易日 < 转股价 70%；零申报因**转债市价 > 回售价**；09-10 收盘 12.44 元（-2.2%）/市值 58.46 亿 →「**股权弱、债权稳**」剪刀差。

**9 品牌核验记录**：**nautica** 全 corroborate + **新观察项**台湾 NAUTICA Competition 代言人 JR 纪言恺联名款（箭头/闪电）+ 复兴 SOGO 柜点（单城弱信号不入源）；**nerdy** NRDY=美股 Nerdy Inc 歧义延续 + APR 财报日 11/05 + 股息颗粒（2025 派 3,590 KRW / 2026 预估 7,180 KRW / payout 95.48%）+ **运营主体标注分歧登记待核**（中文库「Modeus」vs「APR 时尚」）+ NDY 服装线无新信号；**no_one_else** 爱企查背景=既有（PPB STUDIO/与 chuu 姐妹）+ 俄罗斯 NO ONE/Nitori N+ 污染；**speedo** 亚运游泳 9/20-25 赛程/44 人/张展硕 5 单项=库内一致，**战袍仍未曝光**；**trussardi** FY2025 €29M 全维度全在库，**档案裙仍无品牌背书**；**two_am** **Sunway Pyramid 09-15 未到**（2 天后），媒体明确「已宣布扩张 ≠ 已验证需求」；**mr_mrs** **⚠️ 近名污染新类型**——命中 **Mardi Mercredi**（韩国品牌）与 MR&MRS ITALY（慕漫翊）**为完全不同品牌，不得并入**；**thisisizi8** 100% 污染；**the_mr_young 第 13 轮污染**（雅戈尔/JNBY/Yong Studio）→ **正式建议降频为月度核验**。

**下轮优先**：**peacebird 说明会问题 6（股价支撑）答复原文**（仍截断）+ 10 月三季报加盟降幅；**two_am Sunway Pyramid 09-15 开业核验**（2 天后）；**speedo 9/19 亚运战袍**；**tommy 广州 Residence 9 月底开业** + 9/14 高盛零售大会量化口径；salomon 天猫/抖音标价是否与京东一致 + 首销实证；nautica SelectBlinds 上市价带；nerdy 11/05 APR 三季报。

**注意**：kb_benchmarks 本组除 peacebird 外**仍为 `{}`**；A3 轨迹 09-10(0)→09-11(4)→09-12(2)→**09-13(3)**——大事件兑现期（peacebird 说明会闭环/tommy NYFW+店型/亚运临近）持续放量。**方法论沉淀**：①「**上新期不定价治理**」= 用价格弹性换渠道积极性，代价是价格锚外流（须明确「由谁对消费者发声」）；②「**店型概念输出顺序**」是市场定位信号（欧洲验证→中国复制=中国为规模复制场）；③ 同品牌可跑**重资产独立店型 × 轻资产店中店**双线；④ 判断资本市场处境须**拆「股权侧 × 债权侧」**两条线，**回售零申报 ≠ 利好**；⑤ **⚠️ 新污染类型「近名混淆」**（mr_mrs↔Mardi Mercredi）——检索命中后须先做**品牌身份核验**再入库。
